"""
Script for generating dataset for vortex particle dynamics in presence of boundaries and no viscosity.
...
5) Save the location, strength, core size at t0 and the velocity fields at all time instants.
...
parser.add_argument('--offset', type=list, default=[10, 10], help='neglect regions near boundaries of the '
...
parser.add_argument('--save_dir', type=str, default='../'
                                                    'data/p10_b_gaussian_dataset_120x120_4000',
...
for id in range(N_TRAIN_SAMPLES):
    ...
    for frame in range(len(velocity_filenames)):
