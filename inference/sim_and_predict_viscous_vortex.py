...
parser.add_argument('--location', type=str, default='../../Datasets_LVD/'
                                                    'data/p100_gaussian_dataset_viscous_120x120_4000/val/sim_000000/location_000000.npz',
                    help='path to the npz file with initial particle locations')
parser.add_argument('--strength', type=str, default='../../Datasets_LVD/'
                                                    'data/p100_gaussian_dataset_viscous_120x120_4000/val/sim_000000/strength_000000.npz',
                    help='path to the npz file with initial particle strengths')
parser.add_argument('--core_size', type=str, default='../../Datasets_LVD/'
                                                    'data/p100_gaussian_dataset_viscous_120x120_4000/val/sim_000000/sigma_000000.npz',
                    help='path to the npz file with initial particle core sizes')
parser.add_argument('--viscosity', type=float, default=1.0, help='viscosity of the fluid')
...
parser.add_argument('--ckpt_path', type=str, default='../model/ckpt_vortexnet_2_viscous.pytorch',
                    help='path to the actual checkpoint file (overrides the logs_dir and load_weights_ex argument)')
parser.add_argument('--save_dir', type=str, default='../../Inference_LVD/Vortexnet-2-viscous/Case_1',
...
if opt.sim:
    ...
    fluid = world.add(Fluid(domain=domain, velocity=velocity_0),
                      physics=[IncompressibleFlow(),
                               lambda fluid_1, dt: fluid_1.copied_with(velocity=diffuse(fluid_1.velocity, viscosity * dt))])
