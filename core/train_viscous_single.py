...
from core.datasets import ViscousVortexDataset
...
parser.add_argument('--ex', type=str, default='T2_exp_weight_1.0_depth_2_100_batch_32_lr_1e-3_l2_1e-5_r120_4000', help='name of the experiment')
...
logs_dir = os.path.join('../logs_p1_viscous', opt.ex)
...
if opt.load_weights_ex is not None:
    init_weights_log_dir = os.path.join('../logs_p1_viscous', opt.load_weights_ex)
