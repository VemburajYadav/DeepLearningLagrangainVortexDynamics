...
parser.add_argument('--data_dir', type=str, default='../'
                                                    'data/p100_gaussian_dataset_viscous_120x120_4000/val/',
...
for case in range(len(data_cases)):
    ...
    # Read locations, strengths, core sizes and viscosity
    ...
    viscosity = np.load(os.path.join(data_cases[case], 'viscosity.npz'))['arr_0']
