...
parser.add_argument('--ex', type=str, default='BC_both_gaussian_weight_1.0_depth_5_100_batch_32_lr_1e-2_l2_1e-5_r120_8000_2', help='name of the experiment')
...
logs_dir = os.path.join('../logs_p10_gauss_BC', opt.ex)
...
if opt.order == 0:
    ...
    feat_index = torch.arange(22).to('cuda:0')
    deriv_index = torch.arange(2, 22).to('cuda:0')
