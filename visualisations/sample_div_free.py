...
parser.add_argument('--resolution', type=list, default=[100, 100], help='resolution of the domain (as list: [256, 256])')
parser.add_argument('--domain', type=list, default=[100, 100], help='resolution of the domain (as list: [256, 256])')
parser.add_argument('--offset', type=list, default=[30, 30], help='neglect regions near boundaries of the '
...
fac = np.random.random_sample(size=NPARTICLES) * 15 + 5
...
domain_closed = Domain(RESOLUTION, box=box[0: BOX[0], 0: BOX[1]], boundaries=CLOSED)
...
velocities_div = [divergence_free(velocity_0, domain=domain_closed)]
...
for step in range(NUM_TIME_STEPS):
    ...
    velocities_div.append(divergence_free(fluid.velocity, domain=domain_closed))
...
plt.show()
fig.savefig(os.path.join(save_dir, 'velocity_x_N20_vortex.pdf'), format='pdf', bbox_inches='tight')

fig, ax = plt.subplots(figsize=set_size(width, fraction=1, subplots=(1, 1)))
pos = ax.imshow(velocities_div[0].x.data[0, :, :, 0], cmap='RdBu', vmin=min_val, vmax=max_val)
ax.set_xlim([0, BOX[1]])
ax.set_ylim([0, BOX[0]])
ax.set_xlabel(r'$x$')
ax.set_ylabel(r'$y$', rotation=0)
fig.colorbar(pos, ax=ax)
plt.show()
fig.savefig(os.path.join(save_dir, 'velocity_x_N20_div.pdf'), format='pdf', bbox_inches='tight')
...
fig.colorbar(pos, ax=ax)
plt.show()
fig.savefig(os.path.join(save_dir, 'velocity_y_N20_vortex.pdf'), format='pdf', bbox_inches='tight')

fig, ax = plt.subplots(figsize=set_size(width, fraction=1, subplots=(1, 1)))
pos = ax.imshow(velocities_div[0].y.data[0, :, :, 0], cmap='RdBu', vmin=min_val, vmax=max_val)
ax.set_xlim([0, BOX[1]])
ax.set_ylim([0, BOX[0]])
ax.set_xlabel(r'$x$')
ax.set_ylabel(r'$y$', rotation=0)
fig.colorbar(pos, ax=ax)
plt.show()
fig.savefig(os.path.join(save_dir, 'velocity_y_N20_div.pdf'), format='pdf', bbox_inches='tight')

# fig, ax = plt.subplots(figsize=set_size(width, fraction=1, subplots=(1, 1)))
# pos = ax.imshow(velocities_[10].x.data[0, :, :, 0], cmap='RdBu', vmin=min_val, vmax=max_val)
# ax.set_xlim([0, BOX[1]])
# ax.set_ylim([0, BOX[0]])
# ax.set_xlabel(r'$x$')
# ax.set_ylabel(r'$y$', rotation=0)
...
# fig, ax = plt.subplots(figsize=set_size(width, fraction=1, subplots=(1, 1)))
# pos = ax.imshow(velocities_div[10].x.data[0, :, :, 0], cmap='RdBu', vmin=min_val, vmax=max_val)
# ax.set_xlim([0, BOX[1]])
# ax.set_ylim([0, BOX[0]])
# ax.set_xlabel(r'$x$')
# ax.set_ylabel(r'$y$', rotation=0)
...
# fig, ax = plt.subplots(figsize=set_size(width, fraction=1, subplots=(1, 1)))
# pos = ax.imshow(velocities_div[20].x.data[0, :, :, 0], cmap='RdBu', vmin=min_val, vmax=max_val)
# ax.set_xlim([0, BOX[1]])
# ax.set_ylim([0, BOX[0]])
# ax.set_xlabel(r'$x$')
# ax.set_ylabel(r'$y$', rotation=0)
...
# fig, ax = plt.subplots(figsize=set_size(width, fraction=1, subplots=(1, 1)))
# pos = ax.imshow(velocities_[30].x.data[0, :, :, 0], cmap='RdBu', vmin=min_val, vmax=max_val)
# ax.set_xlim([0, BOX[1]])
# ax.set_ylim([0, BOX[0]])
# ax.set_xlabel(r'$x$')
# ax.set_ylabel(r'$y$', rotation=0)
...
# fig, ax = plt.subplots(figsize=set_size(width, fraction=1, subplots=(1, 1)))
# pos = ax.imshow(velocities_div[30].x.data[0, :, :, 0], cmap='RdBu', vmin=min_val, vmax=max_val)
# ax.set_xlim([0, BOX[1]])
# ax.set_ylim([0, BOX[0]])
# ax.set_xlabel(r'$x$')
# ax.set_ylabel(r'$y$', rotation=0)
...
# ax[1].imshow(velocities_[10].x.data[0, :, :, 0], cmap='RdBu', vmin=min_val, vmax=max_val)
# ax[2].imshow(velocities_[20].x.data[0, :, :, 0], cmap='RdBu', vmin=min_val, vmax=max_val)
# pos = ax[3].imshow(velocities_[30].x.data[0, :, :, 0], cmap='RdBu', vmin=min_val, vmax=max_val)
# plt.show()
# fig.savefig(os.path.join(save_dir, 'velocity_x_N20_T3.pdf'), format='pdf', bbox_inches='tight')
...
ax.grid(True)
plt.show()
fig.savefig(os.path.join(save_dir, 'particle_locations_N20_vortex.pdf'), format='pdf', bbox_inches='tight')
